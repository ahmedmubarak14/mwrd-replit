        ...
        <div className="flex-1 flex items-center">
          <div className="w-full max-w-sm mx-auto lg:mx-0 space-y-8">
            <div className="space-y-2">
              <h1 className="text-3xl font-semibold tracking-tight text-[rgb(16,24,40)]">Log in</h1>
              <p className="text-sm text-[rgb(102,112,133)]">Welcome back! Please enter your details.</p>
            </div>
        ...
        <div className="flex-1 p-5 space-y-4">
          ...
          <div className="rounded-lg border border-[rgb(228,231,236)] p-3 bg-white">
            ...
            <svg viewBox="0 0 220 60" className="w-full h-14">
              ...
              <path d="M0,45 L30,38 L60,42 L90,28 L120,32 L150,18 L180,22 L220,8 L220,60 L0,60 Z" fill="url(#g1)" />
