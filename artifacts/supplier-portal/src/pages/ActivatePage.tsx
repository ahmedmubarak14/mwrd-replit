...
export default function ActivatePage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && localStorage.getItem("mwrd_supplier_token")) {
      setLocation("/");
    }
  }, [setLocation]);
  ...
  const onSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    activate.mutate(
      ...
      {
        onSuccess: (response) => {
          // Supplier portal stores its session under a different key so the
          // two portals don't collide on the same browser.
          ...
          {!token ? (
            ...
            <div className="bg-white rounded-2xl border border-[rgb(228,231,236)] shadow-[0_1px_3px_rgba(0,0,0,0.06)] p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-[rgb(16,24,40)]">Activate your supplier account</h1>
