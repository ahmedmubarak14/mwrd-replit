...
import { Loading01, Mail01, Lock01, Truck01 } from "@untitledui/icons";
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-sidebar flex-col justify-between p-10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-primary flex items-center justify-center shrink-0">
            <Truck01 className="w-5 h-5 text-primary-foreground" />
          </div>
        ...
        <div className="w-full max-w-sm space-y-7">
          <div className="flex items-center gap-3 lg:hidden">
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
              <Truck01 className="w-4 h-4 text-primary-foreground" />
            </div>
